                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-success btn-edit-karyawan"><i class="fa fa-edit">
                                                    Detail</i></button> &nbsp;
                                            <a href="{{ route('delete_petugas', $value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('tambah_petugas') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-form-edit-karyawan" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('update_petugas') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
